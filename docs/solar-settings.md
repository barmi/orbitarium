...
- ×0.010 — Earth의 시각 반경이 Moon 궤도보다 작아져 **Moon과 궤도 링 모두 분리 가능**
- ×0.005 (최저) — 행성이 점에 가까워짐, 거의 "현실 비율"

옵션 옆 **moons visible (×0.01)** 버튼을 누르면 한 번에 위성 분리 모드로
들어갑니다. **reset (×1)** 으로 원복.
...
- 기본: `/`
- Moon 분리 + 별 끄기: `/#?v=1&jd=2461166.5&body=earth&ss=0.010&s=0`
